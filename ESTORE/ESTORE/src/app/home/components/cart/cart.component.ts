...
import { loggedInUser } from '../../types/users.types';
...
export class CartComponent implements OnInit,OnDestroy {
    ...
    constructor(public cartStore:CartStoreItem,public router:Router,private fb:FormBuilder,
    ...
    onSubmit():void{
      ...
      if (!this.userService.isUserAuthenticated) {
        this.alertType = 1;  // Assuming 1 indicates a login prompt
        this.alertMessage = 'Please log in to register your Order';
        return;
      }
    }
